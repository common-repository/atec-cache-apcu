...
<div class="atec-page">';
	...
	<div class="atec-main">';
				...
				<div id="atec_group_pro_package">
					<div id="pro_package_welcome" class="atec-fit" style="margin: 0 auto;">
						<div class="atec-mt-5 atec-border-white atec-bg-w atec-fit" style="font-size: 16px !important; padding: 10px;">
							<ul class="atec-m-0">
							<li>⭐ ', esc_attr__('21 valuable plugins','atec-cache-apcu'), '.</li>					
		...
		$atec_desc_arr		= [
							...
							__('Ads SVG support for media uploads.','atec-cache-apcu'),
		...
		<center>
			<p class="atec-fs-10" style="max-width:80%;">',
				...
				esc_attr__('With an average of 1 ms CPU time, we consider our plugins to be super fast – other plugins typically require much more time','atec-cache-apcu'), '.<br>',
				esc_attr__('OSs supported: Linux (CloudLinux, Debian, Ubuntu), Windows & Mac-OS','atec-cache-apcu'), '.<br>',
				esc_attr__('Webservers tested: Apache, NGINX & LiteSpeed','atec-cache-apcu'), '.
			</p>
